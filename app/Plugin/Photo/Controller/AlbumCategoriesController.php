 ...
 */
class AlbumCategoriesController extends PhotoAppController {
    ...
    public function admin_create() {
        ...
        $headers = $this->Category->find('list', array('conditions' => array('Category.type' => 'Photo', 'Category.header' => 1), 'fields' => 'Category.name'));
        $headers[0] = '';
