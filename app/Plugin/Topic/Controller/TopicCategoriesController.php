 ...
 */
class TopicCategoriesController extends TopicAppController {
    ...
    public function admin_create() {
        ...
        $headers = $this->Category->find('list', array('conditions' => array('Category.type' => 'Topic', 'Category.header' => 1), 'fields' => 'Category.name'));
        $headers[0] = '';
    ...
    public function admin_save() {
        ...
        // clear cache
        Cache::delete('topic.category', 'topic');
