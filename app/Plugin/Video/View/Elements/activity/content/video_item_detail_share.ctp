    ...
    <div class="video-feed-info video_feed_content">
        <div class="video-title" >
            <a
                ...
                <?php else:?>
                    class="feed_title"
                    href="<?php if ( !empty( $video['Video']['group_id'] ) ): ?><?php echo $this->request->base?>/groups/view/<?php echo $video['Video']['group_id']?>/video_id:<?php echo $video['Video']['id']?><?php else: ?><?php echo $this->request->base?>/videos/view/<?php echo $object['Video']['id']?>/<?php echo seoUrl($object['Video']['title'])?><?php endif; ?>"
                <?php endif;?>
            >
