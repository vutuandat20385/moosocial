                           ...
                           <form class="form-horizontal intergration-setting" method="post" enctype="multipart/form-data">                           	   
							   <div class="form-body">
                                   <div class="form-group">
                                       <div class="col-md-7">
                                           <p>
                                               <?php echo __('If subscribtion module is enabled, existing members who have not subscribed to any pakages before will be asked to select a package to continue using site. Do you want to assign a ONE-TIME package to them so that they can continue using site without being asking to select package?
Importance: User role of existing members will not change after the above ONE-TIME package is assigned to them so that they will have the same permissions as they have before.');?>
                                           </p>
