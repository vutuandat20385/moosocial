...
<?php $this->start('west'); ?>
    ...
    <div id="browse">
        ...
        <ul class="list2 block-body menu_top_list">
            ...
            <li><a id="my-friends" data-url="<?php echo $this->request->base?>/users/ajax_browse/home" rel="home-content" href="<?php echo $this->request->base?>/home/index/tab:my-friends"><i class="material-icons">group</i> <?php echo __('Friends')?> <span id="friend_count" class="badge_counter"><?php echo $friend_count?></span></a></li>
            ...
            <?php if (Configure::read('Photo.photo_enabled')): ?>
                <li><a id="my-photos" data-url="<?php echo $this->request->base?>/albums/browse/home" rel="home-content" href="<?php echo $this->request->base?>/home/index/tab:my-photos"><i class="material-icons">photo</i> <?php echo __('My Photos')?> <span class="badge_counter"><?php echo $cuser['photo_count']?></span></a></li>
            <?php endif; ?>
