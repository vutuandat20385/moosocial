...
?>
                    <?php echo $this->Form->select('role_id', $roles,
                        array( 'class' => 'form-control', 'value' => $role_value,
                            'empty' => false ) ); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                    <?php echo $this->Form->select('active', array( 0 => __('No'),
                            1 => __('Yes')),
                        array( 'class' => 'form-control','value' => $user['User']['active'],
                            'empty' => false ) ); ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4">
                    <?php echo $this->Form->select('approved', array( 0 => __('No'),
                            1 => __('Yes')),
                        array( 'class' => 'form-control','value' => $user['User']['approved'],
                            'empty' => false ) ); ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4">
                    <?php echo $this->Form->select('confirmed', array( 0 => __('No'),
                            1 => __('Yes')),
                        array( 'class' => 'form-control','value' => $user['User']['confirmed'],
                            'empty' => false ) ); ?>
