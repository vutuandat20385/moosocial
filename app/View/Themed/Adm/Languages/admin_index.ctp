...
<style type="text/css">
 ...
 ?></td>
                                        ...
                                        <td><?php if ( $language['Language']['key'] != 'eng' ): ?>
                                                <a href="<?php echo $this->request->base?>/admin/languages/do_uninstall/<?php echo $language['Language']['id']?>"><i class="tip icon-trash icon-small" title="<?php echo __('Uninstall');?>"></i></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
