...
<div class="modal-body">
    <div class><?php echo  __('Are you sure you want to remove this follow ?')?></div>
</div>
<div class="modal-footer">
    <form id="removeFollowForm">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <a style="float:left" href="javascript:void(0)" data-uid="<?php echo $user['User']['id']?>" id="removeFollowButton" class="button button-caution"><?php echo __('Ok')?></a>
